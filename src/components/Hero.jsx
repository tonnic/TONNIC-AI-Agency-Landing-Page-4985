      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed transition-colors duration-200">
              TONNIC provides cutting-edge AI voice agents, intelligent chatbots, and automation services designed to revolutionize your recruitment process and boost business productivity.
            </p>
          </motion.div>
        ...
        >
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm dark:shadow-slate-700/10 border border-transparent dark:border-slate-700 transition-colors duration-200">
            ...
            <div className="text-slate-600 dark:text-slate-300 transition-colors duration-200">AI Support Available</div>
          </div>
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm dark:shadow-slate-700/10 border border-transparent dark:border-slate-700 transition-colors duration-200">
            <div className="text-3xl font-bold text-yellow-500 mb-2">80%</div>
            <div className="text-slate-600 dark:text-slate-300 transition-colors duration-200">Faster Recruitment</div>
          </div>
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm dark:shadow-slate-700/10 border border-transparent dark:border-slate-700 transition-colors duration-200">
            <div className="text-3xl font-bold text-yellow-500 mb-2">100%</div>
            <div className="text-slate-600 dark:text-slate-300 transition-colors duration-200">Data Security</div>
          </div>
        </motion.div>
      </div>
    </section>
