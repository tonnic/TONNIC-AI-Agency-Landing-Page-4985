...
const { FiArrowLeft, FiMessageSquare, FiCalendar, FiX } = FiIcons;
...
const AIChatbots = () => {
  ...
  useEffect(() => {
    const handleGlobalEscape = (event) => {
      if (showCalModal) {
        console.log('AIChatbots: Received globalEscape event, closing cal modal');
  ...
  const schemaData = {
    ...
    "@type": "Service",
    "name": "AI Chatbots",
    "description": "Multi-platform AI chatbots for lead generation, customer support, and engagement across websites and social media",
    "provider": {
      "@type": "Organization",
  ...
  return (
    <>
      <SEOHead
        title="AI Chatbots - TONNIC AI Agency | Multi-Platform Customer Engagement"
        description="Deploy intelligent AI chatbots across websites, Facebook, WhatsApp, Instagram, and Pinterest. 24/7 customer support, lead generation, and automated conversations."
        keywords="AI chatbots, chatbot development, Facebook messenger bot, WhatsApp business API, Instagram automation, customer service chatbot, lead generation bot"
        canonicalUrl="https://tonnic.agency/#/aichatbots"
            ...
            >
              ...
              <div className="flex items-center justify-center mb-6">
                <div className="bg-yellow-500 w-16 h-16 rounded-2xl flex items-center justify-center mr-4">
                  <SafeIcon icon={FiMessageSquare} className="w-8 h-8 text-slate-800" />
                </div>
            ...
            >
              ...
              <div className="mb-8 p-6 bg-yellow-50 dark:bg-yellow-100/10 rounded-xl transition-colors duration-200">
                <h2 className="text-2xl font-bold text-slate-800 dark:text-yellow-200 mb-4 flex items-center transition-colors duration-200">
                  <SafeIcon icon={FiMessageSquare} className="w-6 h-6 mr-3 text-yellow-500" />
                  Supported Chatbot Platforms
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {serviceData.chatbotPlatforms.map((platform, index) => (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true" aria-labelledby="cal-modal-title">
          ...
          >
            ...
            <div className="p-6 border-b border-slate-200 dark:border-slate-700 transition-colors duration-200">
              <h3 id="cal-modal-title" className="text-2xl font-bold text-slate-800 dark:text-white transition-colors duration-200">Book Your AI Chatbot Consultation</h3>
              <p className="text-slate-600 dark:text-slate-300 mt-2 transition-colors duration-200">Schedule a 30-minute consultation to discuss your chatbot needs</p>
            </div>
            <div className="h-[600px]">
              <iframe
                ...
                height="100%"
                frameBorder="0"
                title="Book an AI Chatbot consultation with TONNIC"
